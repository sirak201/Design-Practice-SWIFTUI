            ...
            .gesture(
                ...
                .onEnded { value in
                    if self.bottomState.height > 50 {
                        self.showCard = false
                    } else if (self.bottomState.height < -100 && !self.showFull) || (self.bottomState.height < -250 && self.showFull) {
                        self.bottomState.height = -300
                        self.showFull = true
                    } else {
    ...
    var body: some View {
        VStack(spacing : 20) {
            Rectangle()
                ...
                .cornerRadius(3)
                .opacity(0.1)
            Text("This is certficate that is a proof that you have achived the needed milestone to grduate by May 2020")
